...
object Bag {
    ...
    private val bag = mutableMapOf<String, Int>()

    fun add(nums: List<Int>, steps: Int) {
        this.bag[this.convert(nums)] = steps
    }
    ...
    fun get(nums: List<Int>): Int {
        return this.bag[convert(nums)] as Int
    }
...
//        println(nums)
    ...
    val loopSize = steps - Bag.get(nums)
    println("Loop size: %d".format(loopSize))
